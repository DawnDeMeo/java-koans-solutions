...
public class AboutDates {
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), "Tue Apr 03 08:33:21 EST 1973");
    }
    ...
    public void usingRollToChangeDatesDoesntWrapOtherFields() {
        ...
        assertEquals(cal.getTime().toString(), "Sat Mar 03 08:33:21 EST 1973");
    }
    ...
    public void usingDateFormatToParseDates() throws ParseException {
        ...
        assertEquals(date2.toString(), "Sat Jan 01 00:00:00 EST 2000");
        // What happened to the time? What do you need to change to keep the time as well?
        // The SimpleDateFormat argument would need to include the time, something like
        // "MM-dd-yyyy h:mm a"
    }
}
